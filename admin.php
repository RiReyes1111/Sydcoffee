...
/* BANNER */
.banner{background:var(--espresso);border-radius:var(--radius);padding:24px 28px;margin-bottom:20px;display:flex;align-items:center;justify-content:space-between;gap:16px;}
...
.banner-sub{font-size:11px;color:#7a6040;}
